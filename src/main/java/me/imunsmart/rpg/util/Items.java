...
public class Items {
	...
	public static ItemStack createPotion(int tier) {
		ItemStack i = createItem(Material.POTION, 1, 0, Items.nameColor[tier - 1] + Potions.names[tier - 1] + " Potion of Healing", Arrays.asList("Restores: " + Potions.amounts[tier - 1]));
