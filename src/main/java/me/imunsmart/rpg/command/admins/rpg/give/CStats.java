	...
	public static void run(Player p, String[] args) {
		if (args.length == 2) {
			...
			if (args[1].equalsIgnoreCase("seti")) {
				...
				p.sendMessage(ChatColor.GREEN + "Set the stat of " + tp.getName() + "'s " + stat + " to " + i + ".");
				...
				p.sendMessage(ChatColor.GREEN + "Set the stat of " + tp.getName() + "'s " + stat + " to " + d + ".");
			} else if (args[1].equalsIgnoreCase("sets")) {
				String s = args[3];
				Stats.setStat(tp, stat, s);
				p.sendMessage(ChatColor.GREEN + "Set the stat of " + tp.getName() + "'s " + stat + " to " + s + ".");
			} else {
